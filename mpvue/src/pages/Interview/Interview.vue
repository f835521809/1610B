<template>
    <form class="box" @submit="submit" report-submit>
        <p>面试信息</p>
        <ul class="uls">
            <li>
                <span>公司名称</span>
           ...
           <li>
               <span>公司电话</span>
               <input type="text" v-model="current.phone" placeholder="请输入面试联系人电话" maxlength="11">
           </li>
           <li>
               <span>面试时间</span>
                <picker
...
export default {
  ...
  methods: {
    ...
    // 去选择地址
    goSearch(){
      wx.navigateTo({ url: '/pages/adress/main' });
    },
    // 提交添加面试
    async submit(e){
      console.log('e...', e);
